...
<head>
    ...
    <title></title>
    <!-- Icons -->
    <link href="{!!  asset('citi_admin/css/font-awesome.min.css')  !!}" rel="stylesheet">
    <link href="{!!  asset('citi_admin/css/simple-line-icons.min.css')  !!}" rel="stylesheet">
...
<body>
  <div id="menu">
    ...
    <script src="{!!  asset('citi_admin/js/pace.min.js')  !!}"></script>


    <!-- Plugins and scripts required by all views -->
    <script src="{!!  asset('citi_admin/js/Chart.min.js')  !!}"></script>


    <!-- GenesisUI main scripts -->

    <script src="{!!  asset('citi_admin/js/app.js')  !!}"></script>


    <!-- Plugins and scripts required by this views -->
    <script src="{!!  asset('citi_admin/js/gauge.min.js')  !!}"></script>


    <!-- Custom scripts required by this view -->
    <script src="{!!  asset('citi_admin/js/views/main.js')  !!}"></script>
