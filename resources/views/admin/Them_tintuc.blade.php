                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" id="texttieude" name="texttieude" class="form-control" placeholder="Nhập tên tiêu đề bài viết">
                            </div>
                            <div class="col-12">
                                <label>Nhập URL</label>
                                <input type="text" id="textURL" name="textURL" class="form-control" placeholder="Nhập URL">
                            </div>
                            <div class="col-12">
                                <label>Search Title</label>
                                <input type="text" id="Search" name="textURL" class="form-control" placeholder="Search Title">
                            </div>
                            <div class="col-12">
                                <label>Search Description</label>
                                <input type="text" id="Description" name="textURL" class="form-control" placeholder="Search Description">
                            </div>
                            <div class="col-12">
                                <label>Tag</label>
